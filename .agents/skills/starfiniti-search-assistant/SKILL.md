...
# Starfiniti Search Assistant repository entry

Read and follow the canonical customer skill at `../../../plugin/starfiniti-search/ai/starfiniti-search-assistant/SKILL.md`. Resolve all relative references from `plugin/starfiniti-search/ai/starfiniti-search-assistant/`.

The packaged customer skill is the source of truth. Do not create a repository-only interpretation.
